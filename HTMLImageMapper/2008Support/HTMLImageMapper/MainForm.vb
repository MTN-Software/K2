Public Class frmMain
    ...
    Private Sub _MouseHover(sender As Object, e As MouseEventArgs) Handles picImage.MouseMove
    ...
    Private Sub btnGenImageMap_Click(sender As Object, e As EventArgs) Handles btnGenImageMap.Click
        ...
        Dim strRectMap As String = "<map name="" " & strMapName & " "">" & _
                                   vbNewLine & vbTab & "<area shape=""rect"" coords=""" & intCoords(1).ToString() & "," & intCoords(2).ToString() & "," & intCoords(3).ToString() & "," & intCoords(4).ToString() & """  href=""" & strHref & """ alt=""Something""/>" & _
                                   vbNewLine & "</map>"
        Dim dlgCopy As DialogResult = MessageBox.Show(strRectMap & vbNewLine & "Pressing ok will set the above text to your clipboard", "MTN HTML Image Mapper - Code", MessageBoxButtons.OKCancel)
